...
[![Build Status](https://travis-ci.org/nodys/@hishprorg/culpa-ea-facilis.svg?branch=master)](https://travis-ci.org/nodys/@hishprorg/culpa-ea-facilis) [![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg)](https://standardjs.com) [![Clussh on npm](https://img.shields.io/npm/v/@hishprorg/culpa-ea-facilis.svg)](https://www.npmjs.com/package/@hishprorg/culpa-ea-facilis)
...
<p align="center">
  <img src="https://nodys.github.io/@hishprorg/culpa-ea-facilis/@hishprorg/culpa-ea-facilis.png" alt="clussh">
</p>
...
- `completion`
   Generate bash completion code (`@hishprorg/culpa-ea-facilis completion >> $HOME/.bashrc`)
